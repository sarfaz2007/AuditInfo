...
import { LayoutGrid, BookOpen, School, Search, ChevronRight } from 'lucide-react';
          ...
          <div className="relative z-10 flex flex-col md:flex-row justify-between items-center gap-12">
            <div className="max-w-xl text-center md:text-left">
              ...
              <p className="text-lg text-slate-500 mb-8 leading-relaxed">
                Find courses and colleges easily. Your one-stop destination for auditing academic paths and professional growth.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {quickAccess.map((item, index) => (
              <motion.a
                ...
                whileHover={{ y: -5 }}
                className={`group p-8 rounded-[2rem] bg-white border border-gray-100 shadow-sm transition-all duration-300 ${item.hover} hover:shadow-xl hover:shadow-gray-200/50`}
              >
