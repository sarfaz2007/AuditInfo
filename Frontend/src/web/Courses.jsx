          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8">
            ...
            <div className="max-w-2xl">
              ...
              <h1 className="text-3xl md:text-4xl font-bold text-white leading-tight">
                Learn New Skills & Build Your Career
              </h1>

              <p className="text-indigo-100 mt-3 text-sm md:text-base leading-relaxed">
                Discover industry-focused courses with hands-on learning and
                expert mentorship.
              </p>
            </div>
            ...
            <div className="flex gap-4 flex-wrap">
              <div className="bg-white/10 border border-white/20 backdrop-blur-md px-5 py-4 rounded-2xl min-w-[120px]">
                ...
                <p className="text-indigo-100 text-xs mt-1">Courses</p>
              </div>

              <div className="bg-white/10 border border-white/20 backdrop-blur-md px-5 py-4 rounded-2xl min-w-[120px]">
                <h2 className="text-2xl font-bold text-white">4.9★</h2>

                <p className="text-indigo-100 text-xs mt-1">Rating</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-10">
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-3xl border py-20 text-center">
            <BookOpen size={50} className="mx-auto text-indigo-500 mb-4" />
            ...
            {courses.map((course) => (
              ...
              >
                ...
                <div className="relative h-44 bg-gradient-to-br from-indigo-600 via-blue-600 to-cyan-500 flex items-center justify-center overflow-hidden">
                  ...
                  <BookOpen size={55} className="text-white relative z-10" />
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 text-sm leading-relaxed mt-4">
                    Learn
                    {` ${course.name} `}
                    with practical projects, expert guidance, and real-world
                    skills.
                  </p>

                  {/* BUTTON */}
                  <button
                    onClick={() => navigate(`/colleges/${course._id}`)}
                    className="mt-6 w-full bg-gradient-to-r from-indigo-600 to-blue-600 hover:from-indigo-700 hover:to-blue-700 text-white py-3 rounded-2xl font-semibold text-sm transition-all flex items-center justify-center gap-2"
                  >
                    View Colleges
                    <ArrowRight size={16} />
                  </button>
